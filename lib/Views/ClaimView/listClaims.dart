...
class _ListClaimsState extends State<ListClaims> {
  ...
  void initState() {
    ...
    _futureOrders = claimViewModel.getClaimsByCarrier();
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                children: [
                                  ...
                                  SizedBox(height: 10,),
                                  if(orders[index]['reclamation']['statusReclamation'] == "NOT_RESOLVED")
                                    ElevatedButton.icon(
                                      icon: Icon(Icons.check_circle, color: ColorTheme
                                          .backgroundNormalColor),
                                      label: Text('Resolved',style: TextStyle(color: ColorTheme
                                          .backgroundNormalColor),),
                                      onPressed: () async {


                                        if(await claimViewModel.resolvedClaim(orders[index]['reclamation']['reclamationNumber'])){
                                          ...
                                          Navigator.popAndPushNamed(context,'/listClaims');
                                        }
