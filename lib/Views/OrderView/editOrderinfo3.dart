            ...
            onTap: () {
              setState(() {
                ...
                if(i==0){
                  ...
                  StaticMethode.staticOrder.startingPoint = _arrivalPointController.text;
...
/*
  ...
  void _handleSearchResultTap(String address) async {
    try {
      // Construct the search query
      String url =
          'http://nominatim.openstreetmap.org/search?q=$address&format=json&limit=1&countrycodes=TN&accept-language=fr';
